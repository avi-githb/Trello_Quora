...
@NamedQueries({
        ...
        @NamedQuery(name = "setLogOutAt", query = "UPDATE  UserAuthTokenEntity ut SET ut.logoutAt =:logout where exists (select u from UserAuthTokenEntity u where u.accessToken =:accessToken)")
})
